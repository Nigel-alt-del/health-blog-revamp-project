    ...
    <BlogLayout>
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="prose prose-lg prose-headings:text-[#20466d] prose-a:text-[#22aee1] prose-strong:text-[#20466d] max-w-none">
          ...
          <p>
            Supplemental terms and conditions or documents that may be posted on the Services from time to time are hereby expressly incorporated herein by reference. We reserve the right, in our sole discretion, to make changes or modifications to these Legal Terms from time to time. We will alert you about any changes by updating the 'Last updated' date of these Legal Terms, and you waive any right to receive specific notice of each such change. Please ensure that you check the applicable Legal Terms every time you use our Services so that you understand which Legal Terms apply. You will be subject to, and will be deemed to have been made aware of and to have accepted, the changes in any revised Legal Terms by your continued use of the Services after the date such revised Legal Terms are posted.
          </p>
          ...
          <p>
            Subject to your compliance with these Legal Terms, including the 'PROHIBITED USES' section below, we grant you a non-exclusive, non-transferable, revocable licence to:
          </p>
          <ul>
